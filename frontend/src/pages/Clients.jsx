                    ...
                    <div className="modal-content" style={{ maxWidth: 500 }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ padding: 24 }}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-input" value={maskPhone(formData.whatsapp)} onChange={e => setFormData({ ...formData, whatsapp: e.target.value })} placeholder="(00) 00000-0000" maxLength={15} required inputMode="numeric" />
                            </div>
